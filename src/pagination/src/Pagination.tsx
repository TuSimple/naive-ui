...
export default defineComponent({
  ...
  setup (props) {
    ...
    const jumperValueRef = ref(props.simple ? String(mergedPageRef.value) : '')
  ...
  render () {
    ...
    return (
      ...
      >
        ...
        {simple ? (
          <div class={`${mergedClsPrefix}-pagination-simple`}>
            ...
            <span class={`${mergedClsPrefix}-pagination-simple-slash`}>/</span>
            {mergedPageCount}
          </div>
        ) : (
